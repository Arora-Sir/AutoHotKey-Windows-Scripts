...
1. Copy all contents of this directory:
   ...
   - `WindowSpy.ahk`
   - `mic_muted.ico`
   - `tablet_hibernate.ico`
2. Paste them into your main AutoHotkey installation directory:
   - Default v2 64-bit path: `C:\Program Files\AutoHotkey\v2\` (or `C:\Program Files\AutoHotkey\`)
...
| `tablet_hibernate.ico` | Multi-resolution power icon (16px to 64px) with high-contrast glyph on dark backdrop. | Dynamic Tablet Only tray indicator and double-click safe hibernation trigger displayed by `SunshineDisplayWatchdog.ahk` |
